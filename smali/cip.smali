...
.method public constructor <init>(Lmoo;Lmon;Lcin;)V
    ...
    :cond_10
    invoke-virtual/range {p1 .. p1}, Lmoo;->isAsus2019()Z

    move-result v4

    if-eqz v4, :cond_11

    invoke-static {v0, v0}, Lcom/configs/isAsus2019;->overrideDefaults(Lchl;Lchh;)V

    goto/16 :goto_6

    :cond_11
    invoke-virtual/range {p1 .. p1}, Lmoo;->isZenfone5Z()Z

    move-result v4

    if-eqz v4, :cond_12

    invoke-static {v0, v0}, Lcom/configs/isZenfone5Z;->overrideDefaults(Lchl;Lchh;)V

    goto/16 :goto_6

    :cond_12
    invoke-virtual/range {p1 .. p1}, Lmoo;->isRogPhone3()Z

    move-result v4

    if-eqz v4, :cond_13

    invoke-static {v0, v0}, Lcom/configs/isRogPhone3;->overrideDefaults(Lchl;Lchh;)V
